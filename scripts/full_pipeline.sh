...
log "  python scripts/push_to_hub.py --model-path ${MERGED_DIR} --repo-id KIM3310/qwen2.5-7b-tool-call-lora"
log "  python scripts/push_to_hub.py --model-path ${AWQ_DIR} --repo-id KIM3310/qwen2.5-7b-tool-call-awq"
