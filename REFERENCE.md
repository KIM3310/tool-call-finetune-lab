> Historical setup and planning reference. The root README and current engineering notes define the verified behavior; old metrics are not newly measured results.
