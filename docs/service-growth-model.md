# Service Growth Model - tool-call-finetune-lab
...
| Field | Decision |
|---|---|
| Service type | Tool-call evaluation and adaptation |
| Primary reader or buyer | AI teams improving tool-call accuracy and test coverage. |
| Wedge | Model adaptation study using approved datasets and reproducible evals. |
